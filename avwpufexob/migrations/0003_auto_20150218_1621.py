...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='gphdl',
            field=models.ForeignKey(on_delete=models.CASCADE, null=True, related_name='+', to='wawqcpvrz.Tyhxj'),
        ),
        migrations.AddField(
            model_name='fvlkcjd',
            name='onlvfzdsk',
            field=models.ForeignKey(on_delete=models.CASCADE, null=True, related_name='+', to='zxxavsovs.Kiikphbz'),
        ),
    ]
