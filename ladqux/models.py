...
class Zhgafcksok(models.Model):
    nwofpfncc = models.ForeignKey('avwpufexob.Yejdqycpmg', on_delete=models.CASCADE, null=True, related_name='+')
    pass
...
class Oeyhu(models.Model):
    ...
    pdbekl = models.IntegerField(default=0)
    pass
...
class Oxrskkvi(models.Model):
    oijcmehk = models.ForeignKey('avwpufexob.Vxucuqwa', on_delete=models.CASCADE, null=True, related_name='+')
    pass
